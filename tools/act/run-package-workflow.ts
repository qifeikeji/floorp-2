...
const parsed = parseArgs(Deno.args, {
  ...
  default: {
    workflow: ".github/workflows/build_appimage.yml",
    ref: "main",
    beta: false,
    "skip-signing": true,
    "runtime-run-id": "",
...
function printHelp() {
  console.log(
    `run-package-workflow.ts - Deno helper to execute build_appimage.yml via act
...
OPTIONS:
  ...
  --workflow <path>        Workflow file path (default: .github/workflows/build_appimage.yml)
